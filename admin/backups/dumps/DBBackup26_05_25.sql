...
-- Started on 2025-05-26 12:32:42
...
INSERT INTO public.representation (id_representation, titre, type, date_representation, image, salle, description, prix) VALUES (12, 'test', 'TEST', '2025-04-24 00:00:00+02', 'azddazdzadza', 1, NULL, NULL);
...
INSERT INTO public.representation (id_representation, titre, type, date_representation, image, salle, description, prix) VALUES (30, 'AAAAAAAAAAAAAAAAA', 'AAAAAAAAAAAAAAAAA', '2025-04-22 00:00:00+02', 'AAAAAAAAAAAAAAAAAAAAA', 1, 'AZRZAFAZFAZFZA', '');
INSERT INTO public.representation (id_representation, titre, type, date_representation, image, salle, description, prix) VALUES (31, 'AAAAAAAAAAAAAAAAA', 'AAAAAAAAAAAAAAAAA', '2025-04-22 00:00:00+02', 'AAAAAAAAAAAAAAAAAAAAA', 1, 'AZRZAFAZFAZFZA', '');
INSERT INTO public.representation (id_representation, titre, type, date_representation, image, salle, description, prix) VALUES (32, 'AAAAAAAAAAAAAAAAA', 'AAAAAAAAAAAAAAAAA', '2025-04-22 00:00:00+02', 'AAAAAAAAAAAAAAAAAAAAA', 1, 'AZRZAFAZFAZFZA', '');
INSERT INTO public.representation (id_representation, titre, type, date_representation, image, salle, description, prix) VALUES (25, 'test', 'test', '2026-08-04 00:00:00+02', '', 1, '', '12');
INSERT INTO public.representation (id_representation, titre, type, date_representation, image, salle, description, prix) VALUES (36, 'AAAAAAAAAAAAA', 'AAAAAAAAAAAAA', '2025-04-29 00:00:00+02', 'AZDZADZADZAD', 1, 'AZDZADZDAZDAZA', '12');
INSERT INTO public.representation (id_representation, titre, type, date_representation, image, salle, description, prix) VALUES (3, 'La bohème', 'Opéra', '2025-06-12 02:00:00+02', 'boheme.png', 2, '"Dans le Paris bohème du XIXᵉ siècle, suivez les rêves, les amours et les espoirs d''une bande d''artistes passionnés. "La Bohème" de Puccini célèbre la jeunesse, la beauté de l''instant... et la fragilité de la vie."', '9.50');
INSERT INTO public.representation (id_representation, titre, type, date_representation, image, salle, description, prix) VALUES (26, 'azdzadzadaz', 'qsdqsdsqazddaz', '2025-06-30 00:00:00+02', 'azdzadzadza', 1, 'azdazdazdaz', '');
INSERT INTO public.representation (id_representation, titre, type, date_representation, image, salle, description, prix) VALUES (2, 'Romeo & Juliet', 'Pièce de théatre', '2025-05-29 20:00:00+02', 'romeo_juliet.jpg', 4, '"L''histoire tragique des amants de Vérone, prisonniers de la haine de leurs familles respectives. Entre passion interdite, serments secrets et destins brisés, "Roméo & Juliette" explore l''amour absolu, plus fort que la mort."', '12.30€');
INSERT INTO public.representation (id_representation, titre, type, date_representation, image, salle, description, prix) VALUES (19, 'Concert de Jazz', 'Musique', '2026-01-01 00:00:00+01', '', 2, 'Concert de jazz avec des artistes renommés.', '22');
INSERT INTO public.representation (id_representation, titre, type, date_representation, image, salle, description, prix) VALUES (21, 'test', 'test', '1970-01-01 00:00:00+01', '', 3, 'test', '13');
...
SELECT pg_catalog.setval('public.representation_id_representation_seq', 41, true);
...
SELECT pg_catalog.setval('public.reservation_id_reservation_seq', 6, true);
...
-- Completed on 2025-05-26 12:32:42
